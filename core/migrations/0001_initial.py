# Generated by Django 3.1.6 on 2021-03-01 07:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conference_format_id', models.CharField(choices=[('Ochnoe', 'Очное'), ('Zaochnoe', 'Заочное')], max_length=500, verbose_name='Формат проведения конференции')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memberinfo_user', models.OneToOneField(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('member_file', models.FileField(upload_to='', verbose_name='Файл')),
                ('member_application_status', models.CharField(choices=[('Consideration', 'На рассмотрении'), ('Denial', 'Отказ'), ('Approved', 'Одобрено'), ('Revision', 'На доработку')], max_length=100, verbose_name='Статус рассмотрения')),
                ('member_application_comment', models.TextField(verbose_name='Комментарий')),
                ('member_conference_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.conference', verbose_name='Конференция')),
                ('member_name', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='Участник')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('conference_sections_name', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.conference', verbose_name='Направление')),
            ],
        ),
        migrations.AddField(
